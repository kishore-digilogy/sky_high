...
class AllFreeExamsPage extends StatelessWidget {
  final List<FreeExamModel> exams;

  const AllFreeExamsPage({super.key, required this.exams});
                  ...
                  child: Row(
                    children: [
                      SizedBox(
                        ...
                        child: Text(
                          'NO.',
                          style: GoogleFonts.inter(fontSize: 10, fontWeight: FontWeight.w700, color: const Color(0xFF64748B), letterSpacing: 0.5),
                        ),
                      ),
                          ...
                          Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (exam.companyName != null && exam.companyName!.isNotEmpty) ...[
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  ...
                                  if (token != null && token.isNotEmpty) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => MockTestPage(setName: exam.setName)));
                                  } else {
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(6),
                                    boxShadow: [
                                      BoxShadow(color: const Color(0xFF6366F1).withOpacity(0.2), blurRadius: 4, offset: const Offset(0, 2)),
                                    ],
                                  ),
                                  child: Row(
